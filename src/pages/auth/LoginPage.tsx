...
import { loginUser, signInWithGoogle, clearError } from '../../store/slices/authSlice';
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold mb-2 text-gray-900">Welcome to Listed</h1>
          <p className="text-gray-600">Connect with professionals and opportunities</p>
        </div>
